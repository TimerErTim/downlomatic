...
import eu.timerertim.downlomatic.core.Launcher
import java.io.File
...
object Log {
    ...
    private val DEFAULT_FILE_PATTERN = Launcher::class.java.protectionDomain.codeSource.location.path
        .replace(File.separator, "/").replaceAfterLast("/lib/downlomatic", "", "")
        .replaceAfterLast("/lib", "").replaceAfterLast("/", "") +
            "logs/downlomatic%g.log"
